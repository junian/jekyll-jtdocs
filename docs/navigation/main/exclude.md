...
The `nav_exclude` parameter does not affect the [breadcrumbs]({{ site.baseurl }}{% link docs/navigation/parents.md %}), nor the [lists of child pages]({{ site.baseurl }}{% link docs/navigation/children.md %}), which you can use to access pages excluded from the main navigation.
