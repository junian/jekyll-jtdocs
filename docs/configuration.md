...
jekyll-jtdocs has some specific configuration parameters that can be defined in your Jekyll site's \_config.yml file.
{: .fs-6 .fw-300 }
...
View this site's [\_config.yml](https://github.com/junian/jekyll-jtdocs/tree/main/_config.yml) file as an example.
...
See [the Code documentation]({{ site.baseurl }}{% link docs/ui-components/code/index.md %}#mermaid-diagram-code-blocks) for more configuration options and information.
...
See [Navigation Structure]({{ site.baseurl }}{% link docs/navigation/main/external.md %}) for more details.
...
footer_content: "Copyright &copy; 2017-2020 Patrick Marsceill. Distributed by an <a href=\"https://github.com/junian/jekyll-jtdocs/tree/main/LICENSE.txt\">MIT license.</a>"
...
gh_edit_repository: "https://github.com/junian/jekyll-jtdocs" # the github URL for your repo
...
See [Callouts]({{ site.baseurl }}{% link docs/ui-components/callouts.md %}) for more information. The colors used in the theme are further described in [Color Utilities]({{ site.baseurl }}{% link docs/utilities/color.md %}).
